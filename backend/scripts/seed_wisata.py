"""
Seed script: membaca dparis_wisata.xlsx → mengisi tabel tourism_objects di MySQL
...
from app.models.tourism import TourismObject  # noqa: import semua model agar tabel terdaftar
...
def seed():
    ...
    try:
        ...
        db.commit()
        print(f"🗑️  Hapus {deleted} data wisata lama")
        ...
        db.commit()
        print(f"✅ {inserted} data wisata berhasil disimpan ke MySQL (tabel: tourism_objects)")
