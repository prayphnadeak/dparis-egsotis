"""
Seed script: membaca dparis_kuliner.xlsx -> mengisi tabel culinary_places di SQLite
...
def seed():
    ...
    try:
        ...
        db.commit()
        print(f"[INFO] Hapus {deleted} data kuliner lama")
        ...
        db.commit()
        print(f"[OK] {inserted} data kuliner berhasil disimpan ke DB")
