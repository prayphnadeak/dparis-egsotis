"""
Seed script: membaca dparis_oleholeh.xlsx -> mengisi tabel souvenir_shops di SQLite
...
def seed():
    ...
    try:
        ...
        db.commit()
        print(f"[INFO] Hapus {deleted} data oleh-oleh lama")
        ...
        db.commit()
        print(f"[OK] {inserted} data oleh-oleh berhasil disimpan ke DB")
