...
class CulinaryRepository(BaseRepository[CulinaryPlace]):
    ...
    def search(self, query: str, category: Optional[str] = None, skip: int = 0, limit: int = 20) -> List[CulinaryPlace]:
    ...
    def get_active(self, skip: int = 0, limit: int = 20) -> List[CulinaryPlace]:
        return (
